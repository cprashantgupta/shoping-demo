...
describe('Category e2e test', () => {
  ...
  it('should load Categories', async () => {
    ...
    expect(await categoryComponentsPage.getTitle()).to.eq('vcartApp.category.home.title');
  ...
  it('should load create Category page', async () => {
    ...
    expect(await categoryUpdatePage.getPageTitle()).to.eq('vcartApp.category.home.createOrEditLabel');
  ...
  it('should create and save Categories', async () => {
    ...
    await promise.all([categoryUpdatePage.setCategoryNameInput('categoryName')]);
  ...
  it('should delete last Category', async () => {
    ...
    expect(await categoryDeleteDialog.getDialogTitle()).to.eq('vcartApp.category.delete.question');
